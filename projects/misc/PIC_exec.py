...
if __name__ == "__main__":
    ...
    fit_operator = prepare_suboperators(Operator(['penalty_coeff']))

    directory = os.path.dirname(os.path.realpath(__file__))
    # grid_file_name = os.path.join(directory, 'grid.npy') # If neccessary, replace by other filename
    # data_file_name = os.path.join(directory, 'wave.npy') # If neccessary, replace by other filename
    ...
    print(wave_eq.vals['u'].fitness, incorrect_eq.vals['u'].fitness)
    assert wave_eq.vals['u'].fitness < incorrect_eq.vals['u'].fitness