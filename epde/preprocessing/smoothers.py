...
def ann_smoother(data, grid, epochs_max = 1e3, loss_mean = 1000, batch_frac = 0.5,
                learining_rate = 1e-4):
...
def gaussian(data, kernel_fun = 'gaussian', **kwargs):
    ...
    if kernel_fun == 'gaussian':
        ...
        raise NotImplementedError('Wrong kernel passed into function. Current version supports only Gaussian smoothing.')
