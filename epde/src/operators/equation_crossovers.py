...
from epde.src.operators.template import Compound_Operator, flatten
...
#        equation1.select_target_idx(separate_vars = separate_vars)
#        equation2.select_target_idx(separate_vars = separate_vars)
#        equation1.check_split_correctness()
#        equation2.check_split_correctness()
