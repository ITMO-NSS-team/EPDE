...
def use_ann_to_predict(model, recalc_grids: List[np.ndarray]) -> np.ndarray:
...
def define_derivatives(var_name: str = 'u', dimensionality: int = 1, max_order: Union[int, List[int]] = 2):
    """
