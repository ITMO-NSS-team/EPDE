...
from epde.interface.interface import InputDataEntry
...
def create_pool(data: Union[np.ndarray, list, tuple], time_axis: int = 0,
    ...
    return TFPool(data_tokens + [tf if isinstance(tf, TokenFamily) else tf.token_family
